...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    var field = this.field,
        value = this.value;
    $("#".concat(field.name)).on("select2:select", this.onChange);
    $("#".concat(field.name)).select2({
    ...
    if (value != null && !(0,_functions__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(value)) {
      if (value.id == undefined) {
        $("#".concat(field.name)).val(value); // Select the option with a value of '1'
      } else {
        $("#".concat(field.name)).val(value.id); // Select the option with a value of '1'
      }

      $("#".concat(field.name)).trigger("change");
    } else {
      $("#".concat(field.name)).val(null); // Select the option with a value of '1'

      $("#".concat(field.name)).trigger("change");
    }

    $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).addClass("form-control default-form-control height-37px");
  },
  ...
  watch: {
    menuItems: function menuItems(newValue) {
      ...
      $("#".concat(field.name)).empty().select2({
        width: "100%",
        theme: "bootstrap",
        placeholder: field.placeholder,
        data: newValue
      ...
      if (!(0,_functions__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(error)) {
        $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).addClass("error-form-control");
        $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).removeClass(["success-form-control", "default-form-control"]);
      } else {
        $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).addClass("default-form-control");
        $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).removeClass("error-form-control");

        if (success) {
          $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).addClass("success-form-control");
          $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).removeClass(["error-form-control", "default-form-control"]);
        } else {
          $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).addClass("default-form-control");
          $("#".concat(field.name, " ~ .select2-container > .selection > .select2-selection")).removeClass("success-form-control");
        }
      }
    },
