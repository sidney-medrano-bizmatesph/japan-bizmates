  ...
  computed: {
    filterableFields: function filterableFields() {
      ...
      return Object.keys(filterableFields).map(function (filterable) {
        return {
          text: filterableFields[filterable].altLabelText ? filterableFields[filterable].altLabelText : filterableFields[filterable].labelText,
  ...
  return _c(
    ...
    [
      ...
      _c(
        "button",
        {
          staticClass: "btn btn-error filter-button mb-2",
          attrs: { type: "button" },
