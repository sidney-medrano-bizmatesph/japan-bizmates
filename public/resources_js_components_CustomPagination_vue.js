  ...
  methods: {
    ...
    onPageChange: function onPageChange(event, type) {
      ...
      switch (type) {
        ...
        case "prev":
          if (parseInt(mainVariable["page"]) - 1 >= 0) state["page"] = parseInt(mainVariable["page"]) - 1;
          break;
        ...
        case "next":
          if (parseInt(mainVariable["page"]) + 1 < pages) state["page"] = parseInt(mainVariable["page"]) + 1;
          break;
  ...
  return _c(
    ...
    [
      ...
      _c(
        "button",
        {
          staticClass: "btn-own btn-light filter-button m-0 rounded-none",
      ...
      _c(
        "button",
        {
          staticClass: "btn-own btn-light filter-button m-0 rounded-l-none",
          attrs: {
            type: "button",
            disabled: _vm.mainVariable.page == _vm.pages - 1
          },
