...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapActions)([page_variables.getter, page_variables.setter])), {}, {
    ...
    onSubmit: function onSubmit() {
      if ((0,_functions__WEBPACK_IMPORTED_MODULE_2__.isEmpty)((0,_functions_validator__WEBPACK_IMPORTED_MODULE_3__.validateAll)({
        misc_name: _FormFields_miscs__WEBPACK_IMPORTED_MODULE_1__.default.misc_name
      }, this))) {
        this.$router.push("/miscellaneous/view/".concat(this.misc_name.id));
      }
    },
    miscGetter: function miscGetter() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(page_variables.get_url, {
        ...
        if (res.data.status == "success") {
          (0,_functions__WEBPACK_IMPORTED_MODULE_2__.formSetter)(field_values, _FormFields_miscs__WEBPACK_IMPORTED_MODULE_1__.default, res.data.result, _this2);
        } else {
