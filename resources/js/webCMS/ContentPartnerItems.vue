<template>
    <FormAndTable>
        ...
        <template v-slot:table>
            ...
            >
                <CustomTableGroup
                    :tableGroupData="{ tableName: 'Partners table' }"
                >
                    <CustomFilter
                        :fields="fields"
                        :getter="getter"
                        :setter="that[page_variables.setter]"
                        :mainVariable="content_partner_items"
                    ></CustomFilter>
                    <CustomTable
                        :fields="fields"
                        :getter="getter"
                    ...
                    >
                        <tr
                            v-for="(
                                partner, key
                            ) in content_partner_items.content_partner_items"
                            :key="`partner-${key}`"
                        >
                            <td>
                                {{
                                    content_partner_items.page *
                                        content_partner_items.rowsPerPage +
                                    key +
                                    1
                                }}
                            </td>
                            ...
                            <td>
                                <router-link
                                    :to="`/cms/content-partners/edit/${partner.id}`"
                                    ><span
                            ...
                            <td>{{ partner.name }}</td>
                            <td v-html="partner.details"></td>
                            <td v-html="partner.collapse"></td>
...
export const page_variables = {
    ...
    parent_url: "/cms/content-partners",
    add_url: "/add-content-partner-item",
    edit_url: "/cms/content-partners/edit",
...
export default {
    ...
    methods: {
        ...
        deleteItem({ id, name }) {
            Swal.fire({
                ...
                if (res.value) {
                    axios
                        .post("/delete-content-partner-item", { id })
                        .then((res) => {
    ...
    watch: {
        ...
        "content_partner_items.count": function (newValue) {
