            ...
            >
                ...
                >
                    <CustomFilter
                        ...
                        :mainVariable="study_guide_videos"
                    ></CustomFilter>
                    <CustomTable
                        :fields="fields"
                        :getter="getter"
                    ...
                    >
                        <tr
                            v-for="(
                                video, key
                            ) in study_guide_videos.study_guide_videos"
                            :key="`video-${key}`"
                        >
                            <td>
                                {{
                                    study_guide_videos.page *
                                        study_guide_videos.rowsPerPage +
                                    key +
                                    1
                                }}
                            </td>
                            <td>
                                <router-link
                                    :to="`/cms/home/study-guide-videos/edit/${video.id}?cms=study-guide`"
...
export const page_variables = {
    ...
    parent_url: "/cms/home?cms=study-guide",
    add_url: "/add-study-guide-video",
    edit_url: "/cms/home/study-guide-videos/edit",
...
export default {
    ...
    methods: {
        ...
        deleteVideo({ id, title }) {
            Swal.fire({
                ...
                if (res.value) {
                    axios
                        .post("/delete-study-guide-video", { id })
                        .then((res) => {
    ...
    watch: {
        ...
        "study_guide_videos.count": function (newValue) {
